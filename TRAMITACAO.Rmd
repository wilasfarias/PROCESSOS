...
output: 
  flexdashboard::flex_dashboard:
    ...
    #theme: united
    theme:
      #bg: "black" # "#FDF7F7" # "#101010" (PLANO DE FUNDO)
      #fg: "white" # "white" , "#FDF7F7" , "#2F4F4F" # COR DA LETRA (PIRMEIRO PLANO)
      #primary: "#483D8B" # "#000000" , "#ED79F9" , "#3ADAC6" # ONDE FICA O TITULO
      navbar-bg: "#000000" # "#3ADAC6" # COR DA PARTE INTERNA DAS INFORMAÇÕES
      ...
      version: 4
      bootswatch: cerulean # minty, cerulean, united, cosmo, spacelab, bootstrap, paper, lumen, journal, sandstone, yeti
    #  fontsize: 12pt
...
grafico <- ggplot(tramitacao, 
                  aes(x=MES, y=`TEMPO DO PROCESSO NO SETOR (DIAS)`, color = `NÚMERO DO PROCESSO (SIPAC/SEI!)`)) + 
  geom_point()
